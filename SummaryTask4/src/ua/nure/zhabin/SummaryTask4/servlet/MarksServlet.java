...
public class MarksServlet extends HttpServlet {
	...
	private void forwardToMarksPage(HttpServletRequest request, HttpServletResponse response,
			MarksBean marksBean, String message) throws ServletException, IOException {
