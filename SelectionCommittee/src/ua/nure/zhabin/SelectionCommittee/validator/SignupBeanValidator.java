...
public class SignupBeanValidator implements Validator<SignupBean> {
	...
	public boolean isValid(SignupBean bean) {
		if (bean.getLogin() == null || bean.getLogin().length() == 0
				...
				|| bean.getMidleName() == null
				|| bean.getMidleName().length() == 0
				|| bean.getLastName() == null
				|| bean.getLastName().length() == 0 || bean.getEmail() == null
				|| bean.getEmail().length() == 0 || bean.getCity() == null
				|| bean.getCity().length() == 0 || bean.getRegion() == null
				|| bean.getRegion().length() == 0
				|| bean.getEducation() == null
				|| bean.getEducation().length() == 0) {
			return false;
		}
		return true;
	}
