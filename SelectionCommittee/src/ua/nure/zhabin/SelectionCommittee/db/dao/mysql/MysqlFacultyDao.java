...
public class MysqlFacultyDao implements FacultyDao {
	...
	public Faculty getById(long facultyId, Connection connection) {
		return jdbcTemplate.get(connection, GET_FACULTY_BY_ID,
				new Object[] { facultyId }, new FacultyMapper());
	}

	@Override
	public Faculty getByName(String name, Connection connection) {
		return jdbcTemplate.get(connection, GET_FACULTY_BY_NAME,
				new Object[] { name }, new FacultyMapper());
	}

	@Override
	public List<Faculty> getAll(Connection connection) {
		return jdbcTemplate.getAll(connection, GET_ALL, new Object[] {},
				new FacultyMapper());
	}
	...
	public void add(Faculty faculty, Connection connection) {
		jdbcTemplate.update(
				connection,
				ADD_FACULTY,
				new Object[] { faculty.getName(), faculty.getBudget(),
	...
	public void delete(long facultyId, Connection connection) {
		jdbcTemplate.update(connection, DELETE_FACULTY,
